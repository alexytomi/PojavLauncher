...
public final class AL {
    ...
    public static void create(String deviceArguments, int contextFrequency, int contextRefresh, boolean contextSynchronized, boolean openDevice)
        ...
        if (alContext == MemoryUtil.NULL && openDevice) {
            ...
            if (error != ALC10.ALC_NO_ERROR) {
                System.err.println("OpenAL contexthandle error: " + error);
            }
            ...
            created_lwjgl2 = true;
            try {
                throw new Exception("OpenAL function: create()");
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public static void create() throws LWJGLException {
        if (alContext == MemoryUtil.NULL) {
            ...
            System.out.println("OpenAL created: " + created_lwjgl2);
...
// -- End LWJGL2 part
    ...
    public static void destroy() {
        System.out.println("OpenAL created: " + created_lwjgl2);
        System.out.println("alContext: " + alContext);
        System.out.println("alcDevice: " + alcDevice + " | " + alcDevice.device);
        try {
            throw new Exception("OpenAL function: destroy()");
        } catch (Exception e) {
            e.printStackTrace();
        }
        // LWJGL2 code
